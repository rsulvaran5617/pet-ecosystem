                    ...
                    {providerBookings.length ? (
                      <div style={{ display: "grid", gap: "10px" }}>
                        {filteredProviderBookings.length ? (
                          ...
                          const isBookingChatOpen = Boolean(
                            bookingThread && selectedProviderMessageThreadDetail?.thread.id === bookingThread.id
                          );
                            ...
                            >
                              ...
                              {isExpanded ? (
                                ...
                                >
                                  ...
                                  {isBookingChatOpen && selectedProviderMessageThreadDetail ? (
                                    <section
                                      style={{
                                    ...
                                    >
                                      <div style={{ display: "grid", gap: "3px" }}>
                                        <span style={{ color: "#0f766e", fontSize: "7px", fontWeight: 900, letterSpacing: "0.08em", textTransform: "uppercase" }}>
                                          Conversacion de esta reserva
                                        </span>
                                      ...
                                      <div style={{ display: "grid", gap: "7px", maxHeight: "220px", overflowY: "auto", paddingRight: "2px" }}>
                                        {selectedProviderMessageThreadDetail.messages.length ? (
                                          ...
                                          <span style={{ color: "#57534e", fontSize: "9px" }}>
                                            Aun no hay mensajes en esta reserva.
                                          </span>
                                        )}
                                      </div>
                                      <form
