  ...
  if (variant === "home") {
    return (
      <section style={cardStyle}>
        ...
        {!errorMessage && infoMessage ? <div style={{ color: colorTokens.adminAccent }}>{infoMessage}</div> : null}
        <div style={{ display: "flex", justifyContent: "space-between", gap: "12px", alignItems: "center" }}>
          ...
          <strong style={{ fontSize: "28px", color: openCases.length ? "#b45309" : colorTokens.adminAccent }}>{openCases.length}</strong>
        </div>
