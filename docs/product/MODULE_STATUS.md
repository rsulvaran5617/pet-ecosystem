...
- Adoption Public Funnel Slice 4 queda implementado localmente: formulario publico ligero por mascota, controles antiabuso, trazabilidad y bandeja Web Foster de interes publico separada de solicitudes formales. Migracion `20260821110000_adoption_public_funnel_slice4.sql` pendiente de dry-run/aplicacion remota; no crea transferencias ni cambia custodia.
- Adoption Public Funnel Slice 5 queda implementado localmente: estado `invited_to_app`, invitacion temporal con token hasheado, CTA de generacion/copia en Web Foster y pagina puente publica con deep link. Migracion `20260822100000_adoption_public_funnel_slice5_invites.sql` pendiente de dry-run/aplicacion remota; claim y conversion formal quedan para Slice 6.
- Adoption Public Funnel Slice 6 queda implementado localmente: claim autenticado por correo, continuidad mobile desde deep link, hogar Owner obligatorio y conversion idempotente a solicitud formal. Migracion `20260822143000_adoption_public_funnel_slice6_owner_conversion.sql` pendiente de dry-run/aplicacion remota; no mueve custodia ni crea transferencia.
