...
- Foster redes sociales publicas queda preparado localmente: `protective_household_public_profiles` suma enlaces opcionales de sitio web/Instagram/Facebook/TikTok/WhatsApp, Web Foster permite editarlos desde Perfil y Owner mobile los muestra solo dentro de `Ver perfil` de mascotas en adopcion. Requiere aplicar migracion `20260726170000_foster_protective_public_social_links.sql` antes de usarlo remoto.
