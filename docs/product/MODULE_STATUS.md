...
- PET ALERT tiene Slice 1A, Slice 4 comunitario y Slice 5 aplicados remoto, ademas de Slice 2 mobile owner y Slice 3 de ficha publica con avistamiento autenticado. Slice 5 incorpora claim autenticado, bandeja privada y contacto autorizado solo tras aprobacion. Moderacion avanzada, fotos comunitarias, escritura anonima y notificaciones push siguen diferidos.
