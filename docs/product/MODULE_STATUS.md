...
- PET ALERT tiene Slice 1A, Slice 4 comunitario y Slice 5 aplicados remoto, ademas de Slice 2 mobile owner y Slice 3 de ficha publica con avistamiento autenticado. Slice 6 queda implementado localmente con reportes autenticados, cola admin y moderacion auditable. Fotos comunitarias, escritura anonima y notificaciones push siguen diferidos.
