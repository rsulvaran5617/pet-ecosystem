...
- Foster-6A/6B compromiso documental queda implementado localmente: plantilla privada de compromiso por Familia Protectora, documento firmado por solicitud, API/tipos, Web Foster para carga/revision y Owner mobile adopcion para descarga/subida. Pendiente aplicar migracion remoto `20260726143000_foster_adoption_commitment_documents.sql`; no bloquea transferencia automaticamente.
