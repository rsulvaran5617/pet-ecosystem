...
- PET ALERT 8A queda disenado documentalmente para permitir en una fase posterior que un propietario no registrado publique con correo verificado. No hay migracion ni escritura anonima habilitada; Pet Alert 8B depende de correo transaccional, CAPTCHA y politica de retencion aprobados.
