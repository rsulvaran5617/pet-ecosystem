...
- PET ALERT 8B queda implementado localmente y pendiente de despliegue controlado: propietario sin cuenta, Turnstile, OTP por Resend, 1-4 fotos, boletin canonico `pending_review` y cola admin. No crea usuario Auth ni publica sin moderacion. Requiere configurar secretos, desplegar Edge Function y aplicar la unica migracion tras dry-run.
