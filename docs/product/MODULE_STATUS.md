...
- APK local de piloto actualizado para messaging notices: `dist/pilot/android/pet-ecosystem-pilot-v0.3.0-messaging-notices-20260522-arm64-release.apk`, SHA256 `139FA9570454E66A6FF9832DA3EC0CDA71D5B019A7D9F5124DCB7A0AD140E8FC`. Build release privado `arm64-v8a`, generado con JSC y copia temporal corta `C:\b22`. Distribucion manual por enlace privado.
