...
- Foster-1A queda implementado localmente y pendiente de aplicacion remota: migracion `20260620133000_foster_1a_protective_household_profiles.sql`, tipos/API client, UI owner en Hogares para solicitar/ver estado y UI admin para revisar/aprobar/rechazar/suspender. No incluye transferencia de mascotas ni marketplace publico de adopcion.
