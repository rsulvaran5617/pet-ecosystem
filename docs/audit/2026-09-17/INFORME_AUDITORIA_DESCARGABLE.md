...
| --- | --- | --- |
| Tipos | Correcto | Siete workspaces; corepack pnpm typecheck |
| Lint | Correcto | Siete workspaces; corepack pnpm lint |
| Android | Correcto | Expo export; bundle Hermes, no ejecución en dispositivo |
| iOS | Correcto | Expo export; bundle Hermes, no ejecución en simulador/dispositivo |
| Web | Correcto | Next.js build de producción local |
| Admin | Correcto | Next.js build de producción local |
| Pruebas nativas | No ejecutadas | ADB sin dispositivos; no entorno iOS en este equipo |
| Regresión clínica local | 36/36 correctas | H04/H05 más las 21 regresiones H01-H03; baseline reproduce ambos fallos |
| Regresión clínica remota | 25/25 correctas antes y después | PostgreSQL real; fixtures revertidos; migración H04/H05 instalada |
| Recuperación cliente/servicio | 9/9 correctas | Lógica real con respuestas de red simuladas |
| Recuperación web y Storage | 7/7 correctas | Web local y PNG real; respuesta de subida perdida, reintento sin duplicación |
