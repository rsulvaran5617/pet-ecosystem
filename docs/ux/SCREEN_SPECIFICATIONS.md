...
- Foster Web Console: `/foster` es una consola web separada para familias protectoras aprobadas. Debe mostrar estados sin sesion/sin familia protectora/en revision/aprobada, selector de familia, dashboard de solicitudes/publicaciones/transferencias, inbox de solicitudes, detalle con timeline y CTAs contextuales. No debe mezclar datos de provider web ni admin web.
