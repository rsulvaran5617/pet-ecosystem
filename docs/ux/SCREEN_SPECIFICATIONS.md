...
- UX-MOBILE-FLOWS Slice 1K: Owner Buscar > proveedor muestra servicios compactos con CTA unico `Ver horarios`; la disponibilidad semanal es informativa y el paso de cupos usa resumen compacto con `Abrir resumen en Reservas`.
