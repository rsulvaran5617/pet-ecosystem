...
- Cuenta provider mantiene perfil, preferencias, direcciones y cambio de rol; hogares, tarjetas guardadas, tarjetas informativas de pagos y tareas owner-only como `Agregar metodo de pago` pertenecen al modo propietario/documentacion QA y no se muestran dentro de la consola provider.
