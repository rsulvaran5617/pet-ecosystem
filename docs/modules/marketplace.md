...
- UX-MOBILE-FLOWS Slice 1K simplifica el paso servicios/horarios: cada servicio muestra metadata compacta y CTA unico `Ver horarios`; `Disponibilidad` queda como referencia semanal y el slot elegido se transfiere a Reservas como resumen sin crear reserva desde Buscar.
