...
- web provider muestra la conversacion solo dentro del acordeon de la reserva seleccionada en `Reservas`; el hilo se abre con `Chatear` y envia respuestas de texto usando `POST /chats/{threadId}/messages`
