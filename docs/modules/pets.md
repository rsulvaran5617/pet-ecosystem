...
- el alta y la edicion normalizan fechas opcionales vacias como `null`; un hogar Owner nunca envia `fosterIntakeDate`, reservado exclusivamente para hogares `protective`.
