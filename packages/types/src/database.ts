    ...
    Tables: {
      ...
      protective_household_public_profiles: {
        Row: {
          ...
          donation_ach_details: string | null;
          donation_yappy_details: string | null;
          donation_paypal_details: string | null;
          donation_external_url: string | null;
          donation_other_details: string | null;
          donation_disclaimer: string | null;
    ...
    Functions: {
      ...
      upsert_protective_public_profile: {
        Args: {
          ...
          next_donations_enabled?: boolean;
          next_donation_title?: string | null;
          next_donation_description?: string | null;
          next_donation_ach_details?: string | null;
          next_donation_yappy_details?: string | null;
          next_donation_paypal_details?: string | null;
          next_donation_external_url?: string | null;
          next_donation_other_details?: string | null;
          next_donation_disclaimer?: string | null;
        };
      ...
      list_my_pet_adoption_listings: {
        ...
        Returns: Array<
          Database["public"]["Tables"]["pet_adoption_listings"]["Row"] & {
            ...
            protective_donation_title: string | null;
            protective_donation_description: string | null;
            protective_donation_ach_details: string | null;
            protective_donation_yappy_details: string | null;
            protective_donation_paypal_details: string | null;
            protective_donation_external_url: string | null;
            protective_donation_other_details: string | null;
            protective_donation_disclaimer: string | null;
          }
        >;
      };
